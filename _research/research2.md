...
excerpt: "As a key member of this project under the China National University Student Innovation & Entrepreneurship Development Program, I was responsible for the perception and partial system development of the robot. Our team won the grand prize at the Global Final of Huawei ICT Competition 2023-2024, where we were one of only four teams from around the world to achieve this recognition.<br/><img src='/images/AeroEye-demo.png'>"
collection: research
author_profile: true
---
...
As the first author of a student, I have published **two invention patents**, which are in the substantive review stage.  
- [Patent1](/images/patent1.png) introduces a method for detecting aircraft engine cracks based on YOLOv5.  
- [Patent2](/images/patent2.png) introduces obstacle avoidance method, system, device and storage medium for aircraft engine defect detection robot.    
